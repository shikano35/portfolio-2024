...
export function Pattern() {
  return (
    // <svg
    //   aria-hidden="true"
    //   className="absolute inset-x-0 -top-14 -z-40 h-[1000px] w-full fill-neutral-50 dark:fill-neutral-950 stroke-neutral-950/5 dark:stroke-neutral-700/20 [mask-image:linear-gradient(to_bottom_left,white_40%,transparent_50%)]"
    //   >
    //     <rect width="100%" height="100%" fill="url(#:r5:)" stroke-width="0"></rect>
